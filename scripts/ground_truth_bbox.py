...
OUTPUT_DIRECTORY = os.path.join(PROJECT_ROOT_DIR, "analysis_resultss")
...
def analyze_frame_with_openai(image_path, detail="low"):
    ...
    # - emotion: primary emotion (happy, sad, neutral, calm, excited, angry, etc.) based on their facial expression.
    # - bbox: A bounding box specifically for the **face** of the person, as a list of four normalized floating-point numbers: [xmin, ymin, width, height].
    #     - xmin: The normalized x-coordinate of the top-left corner of the face's bounding box (0.0 to 1.0, from left edge).
    #     - ymin: The normalized y-coordinate of the top-left corner of the face's bounding box (0.0 to 1.0, from top edge).
    #     - width: The normalized width of the face's bounding box (0.0 to 1.0).
    #     - height: The normalized height of the face's bounding box (0.0 to 1.0).
    #     - Example: "bbox": [0.15, 0.25, 0.30, 0.40]

    # Return ONLY a JSON array of person objects. If no people are present, return an empty array [].
    # Example of a valid response:
    # [
    #   {
    #     "type": "adult", "age": 30, "age_range": "25-35", "gender": "female", "emotion": "happy", "bbox": [0.1, 0.2, 0.3, 0.4]
    #   },
    #   {
    #     "type": "child", "age": 5, "age_range": "4-6", "gender": "male", "emotion": "neutral", "bbox": [0.5, 0.1, 0.2, 0.3]
    #   }
    # ]
    # """
