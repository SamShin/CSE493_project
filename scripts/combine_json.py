...
# --- Configuration ---
INPUT_DIR = "data/per_video_analysis"  # Directory containing individual .json analysis files
FINAL_FRAMES_FILE = "data/per_frame_analysis.jsonl" # Final output with one frame per line
